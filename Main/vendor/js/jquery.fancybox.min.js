        ...
        var a = {
            ...
            , h = function (t, o, i) {
                ...
                s.opts = n.extend(!0, {
                    ...
                    n.fancybox.isMobile && (s.opts = n.extend(!0, {}, s.opts, s.opts.mobile)),
        ...
        n.extend(h.prototype, {
            init: function () {
                ...
                c.scrollTop = r.scrollTop(),
                    ...
                    a = n(c.translate(c, u.baseTpl.replace("{{buttons}}", s).replace("{{arrows}}", u.btnTpl.arrowLeft + u.btnTpl.arrowRight))).attr("id", "fancybox-container-" + c.id).addClass("fancybox-is-hidden").addClass(u.baseClass).data("FancyBox", c).prependTo(u.parentEl),
                    c.$refs = {
                        container: a
                    },
            ...
            createGroup: function (t) {
                ...
                n.each(i, function (t, i) {
                    ...
                    n.isPlainObject(i) ? (l = i,
                        ...
                        "function" === n.type(l.opts.caption) && (l.opts.caption = l.opts.caption.apply(i, [e, l])),
                        l.opts.caption && (l.opts.caption = l.opts.caption === o ? "" : l.opts.caption + ""),
            ...
            activate: function () {
                ...
                n(".fancybox-container").each(function () {
                    ...
                    (t.current || t.isIdle) && (t.$refs.container.index() > 0 && t.$refs.container.prependTo(e.body),
                        t.update(),
                        t.updateControls()),
            ...
            updateControls: function (t) {
                ...
                o.$slide.trigger("refresh"),
                    ...
                    n("[data-fancybox-next]").prop("disabled", !o.opts.loop && i >= e.group.length - 1),
                    "image" === o.type ? n("[data-fancybox-download]").attr("href", o.opts.image.src || o.src) : n("[data-fancybox-download]").hide()
            },
                ...
                i.type || (a = t.extend(!0, {}, n, i.opts.media),
                    ...
                    h ? (i.src = f,
                        ...
                        "iframe" === h && (t.extend(!0, i.opts, {
                            ...
                            i.contentProvider = d,
                            i.opts.slideClass += " fancybox-slide--" + ("gmap_place" == d || "gmap_search" == d ? "map" : "video"))) : f && (i.type = "image"))
            })
        })
        ...
        e.extend(n.prototype, {
            ...
            set: function (t) {
                ...
                console.info("== set; force: " + t),
                    e.instance && e.instance.current && (t === !0 || e.instance.current.opts.loop || e.instance.currIndex < e.instance.group.length - 1) ? (console.info("!!"),
                        e.timer = setTimeout(function () {
                            console.info(">> " + (e.instance.current.index + 1 % e.instance.group.length - 1)),
                                e.instance.jumpTo(e.instance.current.index % e.instance.group.length - 1)
